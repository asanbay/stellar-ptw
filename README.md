...
### 🚀 Production Setup:
- 📊 **[Настройка Supabase](SUPABASE_SETUP.md)** - база данных и аутентификация ✅
- 🌐 **[Деплой на Vercel](DOMAIN_MIGRATION.md)** - миграция с Netlify на Vercel ✅
- ✅ **[Production Ready Checklist](PRODUCTION_READY.md)** - что сделано
- ✅ Analytics & reports
- ✅ Data export
...
- 🪟 **[Windows CSV Fix](WINDOWS_CSV_FIX.md)** - если Excel на Windows показывает кракозябры
